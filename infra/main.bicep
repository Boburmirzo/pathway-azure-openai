...
param confluentClusterEnpoint string = '' // Set in main.parameters.json
param confluentKafkaUser string = '' // Set in main.parameters.json
param confluentKafkaPass string = '' // Set in main.parameters.json
param confluentKafkaTopic string = '' // Set in main.parameters.json
...
module backendApi './core/host/container-app.bicep' = {
  ...
  params: {
    ...
    env: concat([
      ...
      {
        name: 'CONFLUENT_CLUSTER_ENDPOINT'
        value: confluentClusterEnpoint
      }
      {
        name: 'CONFLUENT_KAFKA_USER'
        value: confluentKafkaUser
      }
      {
        name: 'CONFLUENT_KAFKA_PASS'
        value: confluentKafkaPass
      }
      {
        name: 'CONFLUENT_KAFKA_TOPIC'
        value: confluentKafkaTopic
      }
...
// module openAiRoleBackendApi 'core/security/role.bicep' = if (openAiHost == 'azure') {
//   scope: resourceGroup
